...
export interface RockPaperScissorsInterface extends Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic: "GameCompleted" | "GameStarted"
  ): EventFragment;
...
export namespace GameCompletedEvent {
  export type InputTuple = [player: AddressLike, gameNumber: BigNumberish];
  export type OutputTuple = [player: string, gameNumber: bigint];
...
export interface RockPaperScissors extends BaseContract {
  ...
  filters: {
    "GameCompleted(address,uint256)": TypedContractEvent<
      GameCompletedEvent.InputTuple,
      GameCompletedEvent.OutputTuple,
      GameCompletedEvent.OutputObject
    >;
